function [StandardisedCompanyName, CompiledTickers] = StandardiseCompanyName(StandardisedCompanyName)
StandardisedCompanyName = regexprep(StandardisedCompanyName,'Corporation','Corp');
