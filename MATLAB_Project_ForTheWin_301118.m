...
filteredDatav2 = strtrim(filteredDatav2)
% filteredDatav2 = erase(filteredDatav2,"?");
filteredDatav2 = filteredDatav2(~cellfun('isempty', filteredDatav2))

% split to 13 rows of 30
companies = reshape(filteredDatav2,30,[])
companies = companies.'

%Data for company tickers
filteredDatav3 = unique(filteredDatav2)
filteredDatav3 = cellstr(filteredDatav3)

% convert cell array to table
filteredDatav3 = cell2table(filteredDatav3)
